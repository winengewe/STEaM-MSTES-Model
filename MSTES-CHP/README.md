...
2) Open all '.csv' files via Microsoft Excel:
   i) 'en_flows_Win_data' to modify the input data: Current Coylton GSP Electricity Demand (MWh), Coylton 33kV Wind (MWh), West Whitlawburn District Heating (kWh), Air Temp (DegC)
...
5) Change the directory in the 'MSTES-CHP.py' for the inputs (line 13) and outputs (lines 484,1175,178).
6) Change the variables and parameters according to your system design. Main inputs are from line 22 to 79. 
7) Run the code.
